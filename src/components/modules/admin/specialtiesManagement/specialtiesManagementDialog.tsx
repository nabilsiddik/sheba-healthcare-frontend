...
import { createSpeciality } from '@/services/admin/specialtiesManagement'
import { useActionState, useEffect } from 'react'
import { toast } from 'sonner'


interface ISpecialtiesFormDialog {
  open: boolean;
  onClose: () => void
  onSuccess: () => void
}

const specialtiesManagementDialog = ({
  open,
  onClose,
  onSuccess,
}: ISpecialtiesFormDialog) => {
...
export default specialtiesManagementDialog
